...
// Replaces the former Cloudflare-D1 sync logic. Persists subscriptions and
// playback positions to the self-hosted Express API (/api/sync/*).
...
export class SyncManager {
  ...
  async saveFeedToServer(feedUrl, title = '', artwork = '') {
    try {
      await this.api.addSubscription({ feedUrl, title, artwork });
    } catch (e) {}
  }
